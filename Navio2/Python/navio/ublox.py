...
class UBloxMessage:
    '''UBlox message class - contiene un msj binario UBX'''
    def __init__(self):
        self._buf = b""
        self._fields = {}
        self._recs = []
       ...
       # print(msg)
        while True:
           ...
           # print("b")
            ...
            if self.use_xfer:
                if PYTHON_VERSION == 3:
                    bb = bytearray() # Convierte lista a byte array
                    for c in b: # Recorre b y lo va introduciendo en b, y al final se guarda en b.
                        bb.append(c)
                    b = bb
                  #  print("b1")
                   # print(b)
